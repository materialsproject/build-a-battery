    ...
    var methods = {
        init: function (options) {
            ...
            var baseHTML =
                ...
                '<input class="irs-from" value="0"/><input value="0" class="irs-to"/><span class="irs-single">0</span>' +
                '</span>' +
            ...
            var doubleHTML =
                ...
                '<input class="irs-slider from"/>' +
                '<input class="irs-slider to"/>';
            ...
            return this.each(function () {
                ...
                if (parseInt(settings.step, 10) !== parseFloat(settings.step)) {
                    stepFloat = String(settings.step).split(".")[1];
                ...
                this.setData = function (options) {
                    ...
                    if (options.from !== null && 
                        options.from < numbers.toNumber && 
                        options.from >= settings.min){
                        valid = true;
                    }   else if (options.from == null) {
                        options.from = numbers.fromNumber;
                    }
                    if (options.to !== null && 
                        options.to > numbers.fromNumber && 
                        options.to <= settings.max){
                        valid = true;
                    }   else if (options.to == null) {
                        options.to = numbers.toNumber;
                    }
                    if (valid){
                        this.updateData(options)
                        if (settings.onFinish !== null){
                            settings.onFinish.call(this, numbers, slider);                        
                        }                        
                    }
                };
                ...
                var setFields = function () {
                    ...
                    if (settings.type === "single") {
                        ...
                        numbers.fromNumber = parseFloat(numbers.fromNumber);
                        numbers.toNumber = parseFloat(numbers.toNumber);
                        if (!settings.hideText) {
                            ...
                            if (_fromX + _fromW < _toX) {
                                ...
                                $fieldSingle.addClass("irs-range-single");
                                $fieldFrom[0].style.display = "none";
                                $fieldTo[0].style.display = "none";
                            }
                    ...
                    if (typeof settings.onChange === "function") {
                        settings.onChange.call(this, numbers, slider);
                    }
